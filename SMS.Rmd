...
Therefore, we can deduce that the probability of predicting  a Legitmate message as a Spam is quite less (0.06) as compared to the probability of a spam message being predicted as a legitimate message (0.03).
