...
```{r}
libraries <- c("ggplot2", "stringr", "magrittr", "futile.logger", "VennDiagram", "tm", "SnowballC", "wordcloud", "RColorBrewer", "lattice", "caret", "rpart", "rpart.plot", "randomForest", "e1071", "ROCR", "gmodels")
...
Confusion Matrix
```{r}
confusionMatrix(predict(RFSpam_Tree, newdata = test_data), test_data$MessageLabel)
```
